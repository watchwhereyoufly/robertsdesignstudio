// ARCHIVED 2026-08-21. The full-screen video splash that used to live at "/".
// /studio was promoted to the home page and this came out of the routing
// tree. Kept intact -- the folder is underscore-prefixed, which Next treats
// as private and excludes from routing. public/prds-hero.mp4 is still in
// place, so restoring it is a move, not a rebuild.
"use client";

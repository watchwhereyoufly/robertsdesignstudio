...
<div class="hero" id="heroSection">
  <div class="hero-body">
    <div class="hero-nav">
      ...
      <div class="hero-nav-center">Cienfuegos</div>
      <div class="hero-nav-right">
        <span>Hidalgo, MX</span>
        <span>2026</span>
      </div>
    </div>
    <div class="hero-title" style="font-size:clamp(48px, 6vw, 90px);line-height:0.92;letter-spacing:-0.03em;">A Rare Members-Only<br>Tequila Collective Needed<br>To Look Like One.</div>
    <img class="hero-product-img" src="assets/hero-product.jpg" alt="Cienfuegos Release No. 2 bottles in grass at dusk" style="height:47.5%;max-height:400px;">
    <div style="display:flex;justify-content:flex-start;align-items:flex-start;gap:200px;margin-top:40px;">
      <div class="hero-meta" style="flex-direction:column;gap:0;max-width:none;font-size:13px;line-height:1.4;margin-top:0;">
        ...
        <span>Industry: Members-Only Tequila</span>
